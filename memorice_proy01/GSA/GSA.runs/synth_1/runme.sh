...
HD_PWD='D:/VIVADO/Sistemas Electronicos Programables/PROYECTO_01/GSA/GSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GSA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GSA.tcl
