...
HD_PWD='C:/SEP y Anal/Proyecto_01_SEP/memorice_proy01/memorice_proy01/memorice_proy01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rand_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rand_led.tcl -notrace
