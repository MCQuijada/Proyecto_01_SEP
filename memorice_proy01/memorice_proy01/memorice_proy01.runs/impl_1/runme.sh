...
HD_PWD='D:/VIVADO/Sistemas Electronicos Programables/PROYECTO_1/memorice_proy01/memorice_proy01/memorice_proy01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_core.tcl -notrace
