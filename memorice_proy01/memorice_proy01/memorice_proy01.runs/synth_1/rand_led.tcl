...
namespace eval ::optrace {
  variable script "C:/SEP y Anal/Proyecto_01_SEP/memorice_proy01/memorice_proy01/memorice_proy01.runs/synth_1/rand_led.tcl"
...
read_vhdl -library xil_defaultlib {
  ...
  {C:/SEP y Anal/Proyecto_01_SEP/memorice_proy01/memorice_proy01/memorice_proy01.srcs/sources_1/new/rand_led.vhd}
}
...
synth_design -top rand_led -part xc7z010clg400-1
...
write_checkpoint -force -noxdef rand_led.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file rand_led_utilization_synth.rpt -pb rand_led_utilization_synth.pb"
