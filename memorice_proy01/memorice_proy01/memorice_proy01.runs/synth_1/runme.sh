...
HD_PWD='C:/SEP y Anal/Proyecto_01_SEP/memorice_proy01/memorice_proy01/memorice_proy01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rand_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rand_led.tcl
